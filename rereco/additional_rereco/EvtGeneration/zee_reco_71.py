...
#                                           fileName = cms.untracked.string('file:zeetest_reco.root'),
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
                                         ...
                                         eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
                                         outputCommands = process.RECODEBUGEventContent.outputCommands,
                                         fileName = cms.untracked.string('zee_reco.root'),
                                         dataset = cms.untracked.PSet(
    filterName = cms.untracked.string(''),
...
process.RECOSIMoutput.outputCommands.append('keep *_siPixelRecHits*_*_*')
process.RECOSIMoutput.outputCommands.append('keep *_siStripMatchedRecHits_*_*')
process.RECOSIMoutput.outputCommands.append('keep *_MeasurementTrackerEvent_*_*')
process.RECOSIMoutput.outputCommands.append('keep *_*siPixelClusterShapeCache*_*_*')
...
process.zeeFilter_step=cms.Path(process.zeeFilter)

# Path and EndPath definitions
process.raw2digi_step = cms.Path(process.zeeFilter*process.RawToDigi)
#process.L1Reco_step = cms.Path(process.L1Reco)
process.reconstruction_step = cms.Path(process.zeeFilter*process.reconstruction)
process.eventinterpretaion_step = cms.Path(process.zeeFilter*process.EIsequence)
