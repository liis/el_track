#ifndef RecoAlgos_AnalyticalGsfTrackSelector_h
#define RecoAlgos_AnalyticalGsfTrackSelector_h
...
namespace reco { namespace modules {
    ...
    class AnalyticalGsfTrackSelector : public edm::EDProducer {
        private:
        public:
            /// constructor 
            explicit AnalyticalGsfTrackSelector( const edm::ParameterSet & cfg ) ;
            /// destructor
            virtual ~AnalyticalGsfTrackSelector() ;
        ...
        private:
            ...
            bool select (const reco::BeamSpot &vertexBeamSpot, const reco::GsfTrack &tk, const std::vector<Point> &points);
	    ...
	    double max_z0NoPV_;
            ...
            /// storage
            std::auto_ptr<reco::GsfTrackCollection> selGsfTracks_;
            std::auto_ptr<reco::TrackExtraCollection> selGsfTrackExtras_;
            std::auto_ptr<reco::GsfTrackExtraCollection> selGsfTrackGsfExtras_;
            ...
            reco::GsfTrackRefProd rGsfTracks_;
            reco::TrackExtraRefProd rGsfTrackExtras_;
            reco::GsfTrackExtraRefProd rGsfTrackGsfExtras_;
            TrackingRecHitRefProd rHits_;
            //edm::RefProd< std::vector<Trajectory> > rTrajectories_;
            std::vector<reco::GsfTrackRef> trackRefs_;
