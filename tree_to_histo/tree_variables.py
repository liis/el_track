...
int_array_list = [] 
double_list = []
int_2D_array_list = ["gen_passhit075","gen_passhit080"]

double_array_list_hits = ["gen_passhit3_eta", "gen_passlast_eta"]
...
var_list = int_list + int_array_list + double_list + double_array_list + int_2D_array_list
